...
/*configure the sense control options for INT0 channel, Options:
 * 																	1- EXTI_LOW_LEVEL
 * 																	2- EXTI_ON_CHANGE
 * 																	3- EXTI_FALLING_EDGE
 * 																	4- EXTI_RISING_EDGE
...
/*configure the sense control options for INT1 channel, Options:
 * 																	1- EXTI_LOW_LEVEL
 * 																	2- EXTI_ON_CHANGE
 * 																	3- EXTI_FALLING_EDGE
 * 																	4- EXTI_RISING_EDGE
...
/*configure the sense control options for INT2 channel, Options:
 * 																	1- EXTI_FALLING_EDGE
 * 																	2- EXTI_RISING_EDGE
 * 																	*/
